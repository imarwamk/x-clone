...
//   PostDetails(Map<String, dynamic> this.data);
...
//                 children: [
//                   Text(widget.data['title'], style: AppTextStyles.title),
//                   Text(
//                     widget.data['author'],
//                     style: TextStyle(color: Colors.grey),
//                   ),
//                   SizedBox(height: 30),
//                   Text(widget.data['imageUrl'], style: AppTextStyles.subtitle),
//                   SizedBox(height: 30),
//                   Container(
...
//                       imageUrl,
//                       fit: BoxFit.cover,
//                       loadingBuilder: (_, child, lodadingProgress){
//                         if (lodadingProgress == null){
//                           return child;
//                         }
//                         return Center(child: CircularProgressIndicator(
//                           value:  lodadingProgress.expectedTotalBytes != null
//                           ? lodadingProgress.cumulativeBytesLoaded /
//                           lodadingProgress.expectedTotalBytes!
//                           : null,
//                         ),
//                         );
//                       },),
